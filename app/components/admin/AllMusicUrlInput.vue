<template lang="pug">
div.d-flex
  v-text-field(v-model="allMusicUrl" label="AllMusic" hide-details)
  v-btn.ml-2(v-if='allMusicUrl' :icon="mdiOpenInNew" :href="allMusicUrl" target="_blank")
...
const allMusicUrl = defineModel<string>()
