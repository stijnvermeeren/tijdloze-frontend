...
const startYear = ref(useRoute().query.start ? useRoute().query.start : _.first(useRootStore().years)?.yyyy)
const endYear = ref(useRoute().query.einde ? useRoute().query.einde : useRootStore().lastCompleteYear?.yyyy)
