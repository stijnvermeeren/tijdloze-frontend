  ...
  ui-card(title="Landen")
    ...
    p
      ...
      ul
        ...
        li
          make-links(text="[Manu Chao] heeft een dubbele Frans-Spaanse nationaliteit. Hier is Frankrijk als zijn land van herkomst vastgelegd, omdat hij daar geboren en opgegroeid is.")
        li
